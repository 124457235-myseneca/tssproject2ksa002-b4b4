...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33381  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 38063:38063 -p 36645:36645 -p 58793:58793 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssproject2ksa002-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=38063  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36645  \-\-env SOLUTIONVIPERVIZPORT=58793 \-\-env DOCKERUSERNAME='kasunsam' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=33381 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/tssproject2ksa002-b4b4-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38063, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46527, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45141, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45187, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34355, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33425, HPDEHOST=127.0.1.1, HPDEPORT=36547, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43361

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5607-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, python-preprocess-6995-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, python-ai-9962-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
