[tssproject2ksa002-b4b4] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tssproject2ksa002-b4b4] container is NOT running**.

.. tip::
   You must have your [tssproject2ksa002-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=44915  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='kasuna'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/tssproject2ksa002-b4b4-amd64 (https://hub.docker.com/r/kasunsam/tssproject2ksa002-b4b4-amd64)
...
.. important::
   docker run -d -p 58343:58343 -p 48335:48335 -p 48553:48553 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=tssproject2ksa002-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=58343  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=48335  \-\-env SOLUTIONVIPERVIZPORT=48553 \-\-env DOCKERUSERNAME='kasunsam' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=44915 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='kasuna' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/tssproject2ksa002-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/tssproject2ksa002-b4b4-amd64
...
[tssproject2ksa002-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tssproject2ksa002-b4b4
...
.. important::
   https://tssproject2ksa002-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=58343, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33737, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46267, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36423, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34851, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46385, HPDEHOST=127.0.1.1, HPDEPORT=39321, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46383

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-942-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, python-preprocess-8567-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, python-ai-8738-tssproject2ksa002-b4b4,solution_preprocessing_ai_mqtt_dag-tssproject2ksa002-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
